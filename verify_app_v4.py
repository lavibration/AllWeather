...
async def run():
    async with async_playwright() as p:
        ...
        try:
            ...
            # Tab 1: Cockpit
            await page.wait_for_selector("text=Cockpit d'Exécution", timeout=30000)
            await page.screenshot(path="v4_tab1.png")
            print("Captured Tab 1")

            # Tab 2: Signaux & Hystérésis
            await page.get_by_role("tab", name="Signaux & Hystérésis").click()
            # Wait for some content specific to Tab 2
            await page.wait_for_selector("text=Signal Croissance US", timeout=30000)
            # Give Plotly a second to render
            await asyncio.sleep(2)
            await page.screenshot(path="v4_tab2.png")
            print("Captured Tab 2")

            # Tab 3: Analyse des Performances
            ...
            await asyncio.sleep(2)
            await page.screenshot(path="v4_tab3.png")
            ...
            await page.screenshot(path="v4_tab4.png")
